    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Aktivite", "Spor aktiviteleri", true, "Spor" },
                    { 2, "Sanat", "Müzik dinleme ve çalma", true, "Müzik" },
                    { 3, "Yaşam", "Gezme ve seyahat etme", true, "Seyahat" },
                    { 4, "Eğitim", "Kitap okuma", true, "Kitap" },
                    { 5, "Eğlence", "Film izleme", true, "Sinema" },
                    { 6, "Yaşam", "Yemek yapma ve deneme", true, "Yemek" },
                    { 7, "Teknoloji", "Teknoloji ve gadget'lar", true, "Teknoloji" },
                    { 8, "Sanat", "Resim, heykel ve sanat", true, "Sanat" }
                });
